	...
	<header>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><h3>HCLI</h3></a>
			</div>
			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						...
						<a href="/cart/list" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
							Check Out
						</a>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".ハンドガン">
						ハンドガン
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".スナイパーライフル">
						スナイパーライフル
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".サブマシンガン">
						サブマシンガン
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".ガジェット">
						ガジェット
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".その他">
						その他
					</button>
				</div>
...
<!------------------------ コンテンツ ------------------>
        <?php foreach($items as $item): ?>
				...
				<div class="item-height col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?=$item->category?>">
					<!-- Block2 -->
					<div class="block2">
